// <copyright file="GetLineAnnotationResponseDto.cs" company="Isaac Brown">
...
/// <summary>
/// Represents the JSON document which is used to get/read <see cref="LineAnnotation"/> instances.
/// </summary>
public class GetLineAnnotationResponseDto
{
